...
import { setIsCameraOn, setIsMicOn } from '../realtimeCommunication/videoRoomsSlice';
...
const VideoRoomButtons= ({inRoom}) =>{
    ...
    return(
        <div className="m_page_v_rooms_video_buttons_container">
            <button onClick ={handleMuteUnMuteChange} className="m_page_v_rooms_video_button">
            ...
            <button onClick= {handleCameraOnOffChange} className="m_page_v_rooms_video_button">
